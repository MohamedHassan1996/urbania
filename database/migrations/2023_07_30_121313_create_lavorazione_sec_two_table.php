...
return new class extends Migration
{
    ...
    {
        Schema::create('lavorazione_sec_two', function (Blueprint $table) {
            $table->id();
            $table->text('description')->nullable()->default("");
            $table->string('years')->nullable()->default("");
            $table->string('years_values')->nullable()->default("");
            $table->integer('lavorazione_sec_two_parameter_id')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('lavorazione_sec_two');
    }
};
