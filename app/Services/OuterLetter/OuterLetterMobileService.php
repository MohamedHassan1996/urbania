...
class OuterLetterMobileService{
    ...
    public function allOuterLetter(array $filters){
        ...
        $allOuterLetter = OuterLetter::with('clients', 'services')
...
$endOfDay = Carbon::createFromFormat('d/m/Y', $receivedDate)->endOfDay();
    ...
    public function qrEditOuterLetter( $outerLetterId)
    {

        $outerLetter = OuterLetter::where('letter_id', $outerLetterId)->first();
